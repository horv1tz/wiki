...
* [Nginx ](web/nginx.md)- это высокопроизводительный веб-сервер и обратный прокси, используемый для балансировки нагрузки, кэширования и обработки веб-трафика.
...
* [Nexus Sonatype ](artifacts/nexus-sonatype.md)- это инструмент для управления репозиториями, используемый для хранения, проксирования и управления артефактами (библиотеки, зависимости, Docker-образы и т.д.) в процессе разработки ПО.
